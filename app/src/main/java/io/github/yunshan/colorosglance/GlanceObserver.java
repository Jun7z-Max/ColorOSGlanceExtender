...
public final class GlanceObserver extends XposedModule {
    ...
    private static final String RESIDENT_BRIDGE_PREFIX =
            "io.github.yunshan.colorosglance.resident_bridge.";
